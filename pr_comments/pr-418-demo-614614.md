...
### API consumers
- `partner-sdk` (external) — unspecified
- `customer-portal` (internal) — GET /api/customers
- `customer-sdk-python` (sdk) — GET /api/customers v1.4.0

### Schema impacts
- `customer_contract` — readers: finance-ledger, daily-etl — writers: customer-api — pipelines: daily-etl
...
- `llm_call_failed` (llm): Gemini call failed: Client error '400 Bad Request' for url 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3.6-flash:generateContent'
